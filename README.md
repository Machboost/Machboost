...
[![Website](https://img.shields.io/badge/Website-MachBoost-22c55e)](https://machboost.github.io/Machboost/)
...
pip install "machboost[dflash] @ git+https://github.com/Machboost/Machboost.git"
```
...
[MachBoost website](https://machboost.github.io/Machboost/) and
[GitHub Releases](https://github.com/Machboost/Machboost/releases/latest).
...
```sh
python3 -m pip install --upgrade "machboost[vision] @ git+https://github.com/Machboost/Machboost.git"
