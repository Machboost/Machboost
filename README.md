...
```sh
python3 -m pip install "machboost[mlx] @ git+https://github.com/Machboost/Machboost.git@v0.16.7"
python3 -m pip install "machboost[vision] @ git+https://github.com/Machboost/Machboost.git@v0.16.7"
python3 -m pip install "machboost[dflash] @ git+https://github.com/Machboost/Machboost.git@v0.16.7"
```
